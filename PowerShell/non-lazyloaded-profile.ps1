#starship shell completions
using namespace System.Management.Automation
using namespace System.Management.Automation.Language

function Setup-StarshipCompletions {
    #Starship shell completions
    ...
    # End of starship shell completions
}
...
function idea {idea64.exe @Args}
function touch {New-Item @Args}
function profile {notepad C:\Users\Adham\Documents\PowerShell\profile.ps1}
function tmux-config {wsl ~ -d posh_tmux -u root}
function tmux {wsl -d posh_tmux -e tmux @Args}
function ..{cd ..}
function ....{cd ../..}

#function Invoke-Starship-PreCommand {
#    $lastCommand = (Get-History -Count 1).CommandLine
#    Invoke-Expression "wsl.exe -d posh_tmux -e tmux rename-window '$lastCommand'"
#}
...
Remove-PSReadLineKeyHandler -Chord 'Ctrl+Spacebar'  #tmux
Remove-PSReadLineKeyHandler -Chord 'Ctrl+J'  #tmux
Remove-PSReadLineKeyHandler -Chord 'Ctrl+K'  #tmux
...
#        Set-PSReadlineKeyHandler -Key Tab -Function MenuComplete
        ...
        #wsl -d posh_tmux -e tmux rename-window $(Get-History -Count 1).CommandLine
